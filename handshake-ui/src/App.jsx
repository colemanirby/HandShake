...
class App extends Component {
  ...
  buildLoggedInNavBar() {
    ...
    this.state.authNavBarOptions.forEach(navOption => {
      ...
      if (href === '/maketransaction') {
        navOptionsArray.push(
          <NavItem key={key} onClick={() => this.openModal()}>
            {navOption}
          </NavItem>,
        );
      } else {
        navOptionsArray.push(
          <RouteNavItem key={key} href={href}>
            {navOption}
          </RouteNavItem>,
        );
      }
    ...
    navOptionsArray.push(
      <NavItem key={key} onClick={this.handleLogout}>
        Logout
      </NavItem>,
    );
      ...
      !this.state.isAuthenticating && (
        <div className="App container">
          ...
          {this.state.isModalOpen && (
            <TransactionsModal closeModal={this.closeModal} />
          )}
          <Navbar fluid collapseOnSelect>
            ...
            <Navbar.Collapse>
              <Nav pullRight>{this.state.navBarElements}</Nav>
            </Navbar.Collapse>
          </Navbar>
