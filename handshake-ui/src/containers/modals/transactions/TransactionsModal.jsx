...
export default class TransactionsModal extends Component {
      ...
      return (
        <div>
          <div style={this.modalStyle}>
            ...
            <p>hello Beotch 1</p>
            <p>
              <button id="ok" onClick={this.nextStep}>
                Ok
              </button>
            </p>
            <p>
              <button id="close-modal" onClick={this.close}>
                Close
              </button>
            </p>
          </div>
          <div style={this.backdropStyle} onClick={this.close} />
        </div>
      );
      ...
      return (
        <div>
          <div style={this.modalStyle}>
            ...
            <p>hello Beotch 2</p>
            <p>
              <button id="ok" onClick={this.close}>
                Ok
              </button>
            </p>
            <p>
  ...
  close() {
    // closeModal passed in as callback in props from App.jsx parent
